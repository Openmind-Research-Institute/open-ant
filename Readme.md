...
| **Total**                                 |          |                                                                                                              | **$507.98** (excl. shipping)                                                                               | **€566.04** (excl. shipping)                                                                                                                                                                                        |



#### Embodied Ant X

| Part Name                                 | Quantity | Notes                                                                                                       | US Link                                                                                            | US Price (Nov 2025)    |
|-------------------------------------------|----------|-------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|------------------------|
...
| USB-A extension cable                     | 1        | As tether for the robot, 10ft (~3m)                                                                         | [Amazon](https://www.amazon.com/dp/B07ZV6FHWF/)                                                    | $5.99                  |
...
We recommend adding a heat sink to the knee actuators, for example [this (US)](https://www.amazon.com/dp/B08HLZWKYN?ref_=ppx_hzsearch_conn_dt_b_fed_asin_title_1&th=1) or [this (EU)](...todo...) one.
