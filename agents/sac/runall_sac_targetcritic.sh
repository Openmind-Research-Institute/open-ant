...
for SEED in "${SEEDS[@]}"; do
    ...
    python3 sac_targetcritic.py \
        --render_mode rgb_array \
        --env_id SimEmbodiedAnt \
        --runs_directory runs_sim_less_aggresive/sac_target_critic \
        --dt 0.12 \
        --exp_name trial_1 \
    ...
    SIM1_DIR=$(ls -td runs_sim_less_aggresive/sac_target_critic/trial_1_2*_seed_${SEED} | grep -v continual | head -1)
